			...
			<div class="responisve-container">
				<div class="sliders">
					...
					<div class="slide">
						...
						<img 	src="{{asset('images/fraction/01_outofthebox.png')}}" 
								data-position="20,330" data-in="bottomLeft" data-delay="500" data-out="fade">
					</div>

					<div class="slide">
						<img 	src="{{asset('images/fraction/02_big_boxes.png')}}" 		
								data-position="25,445" data-in="fade" data-delay="0" data-out="right">
								
						<img 	src="{{asset('images/fraction/02_small_boxes.png')}}" 	
						...
						<img 	src="{{asset('images/fraction/02_main.png')}}" 
