  ...
  <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
         <h2 class="text-center blue"><strong>Red Hat Certified Engineer (RHCE) Certification Lab Exams</strong></h2>
         <br>
         <h3 class="blue"><strong>Prepare for the Red Hat Certified Engineer exam.</strong></h3>
         <br>
         <p>The Red Hat Certified Engineer (RHCE®) Certification lab (RH300) is designed for students seeking a hands-on, lab-based review prior to taking the RHCE exam (EX300). Students taking this course should have already completed their classroom training and simply be preparing to take or retake the exam.</p>
         <br>


         <h4 class="blue">Course Overview</h4>
         <p>During the 4-day course, students will work at their own pace through the complete set of labs from both the Red Hat Certified System Administrator (RHCSA) Rapid Track course (RH199) and Red Hat System Administration III (RH254). The RHCE Certification Lab course includes a few instructor lectures designed to review key technologies such as systemd, firewalld, and IPv6. For the classroom and virtual classroom versions of this course, an instructor will be available throughout the week to assist students as they work through the labs.</p>
         <br>

         <p><b>Note:</b> This version of the course includes the <a href="https://www.redhat.com/en/services/training/ex200-red-hat-certified-system-administrator-rhcsa-exam">RHCSA (EX200)</a> and <a href="https://www.redhat.com/en/services/training/ex300-red-hat-certified-engineer-rhce-exam">RHCE (EX300)</a> exams on the final day of the course.</p>
        

        <h4><strong>Course content summary</strong></h4>
        <ul>
            <li>Managing and troubleshooting system services during the boot process</li>
            ...
            <li>Network port security and link aggregation</li>
        ...
        <br>
         ...
         <ul>
             <li>RHCE on Red Hat Enterprise Linux 6 or earlier who wish to recertify on Red Hat Enterprise Linux 7</li>
             <li>Students who previously atttemped the RHCE exam, did not pass and wish to retake the exam</li>
             <li>Students who have completed the RHCE track course <a href="https://www.redhat.com/en/services/training/rh124-red-hat-system-administration-i">(Red Hat System Administration I, II and III or equivalent)</a> and would like additional hands-on practice prior to taking the RHCE exam</li>
         </ul>
         <br>
        ...
        <p><b>Logical volume management</b></p>
         ...
         <p><b>Scheduled process</b></p>
         <p>Scheduled task to automatically  execute in the future</p>
         <br>
        ...
        <p><b>Firewall configuration</b></p>
         ...
         <p>Automate the installation</p>
         <br>

         <p><b>Managing IPv6 networking</b></p>
         <p>Configure and troubleshoot basic IPv6 networking on Red Hat Enterprise Linux systems</p>
         <br>
        ...
        <p><b>Configuring the shell environement</b></p>
        <p>Customize bash startup and use environment variables, Bash aliases and Bash functions</p>
        <br>

        <h3 class="blue"><strong>Recommended next exam or course</strong></h3>
        <p>Red Hat OpenStack Administration (CL210)</p>
        <p>Red Hat OpenShift Administration (DO280)</p>
        <p>Red Hat Enterprise Virtualization (RH318)</p>
        <p>Red Hat Enterprise Deployment and Systems Management (RH401)</p>
        <p>Red Hat Server Hardening (RH413)</p>
        <p>Red Hat Enterprise Clustering and Store Management (RH436)</p>
        <p>Red Hat Enterprise Monitoring and Performance Tuning (RH442)</p>
