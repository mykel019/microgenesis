  ...
  <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
         <h2 class="text-center blue"><strong>RHCE Rapid Track Course (with RHCSA and RHCE Exams)</strong></h2>
         <br>
         ...
         <p><b>Note:</b> This version of the course includes the RHCSA (EX200) and RHCE (EX300) exams on the final day of the course.</p>
