  ...
  <div class="row">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
         <h2 class="text-center blue"><strong>Red Hat Enterprise Linux System Administration II with RHCSA Exam</strong></h2>
         <br>
         <h3 class="blue"><strong>Part 2 of the core system administration tasks needed for Red Hat Enterprise Linux</strong></h3>
         <br>
         <p>This version of the course relates to Red Hat® Enterprise Linux® 7. This course is specifically designed for students who have completed Red Hat System Administration I (RH124). This version of the course includes the Red Hat Certified System Administrator Exam (EX200).</p>


         <h4 class="blue">Course Overview</h4>
         <p>Red Hat System Administration II (RH135) focuses on the key tasks needed to become a full time Linux administrator. This course goes deeper into enterprise Linux administration including file systems and partitioning, logical volumes, SELinux, firewalling, and troubleshooting. Attending both Red Hat System Administration I and Red Hat System Administration II can help you in your preparation for the Red Hat Certified System Administrator exam (EX200), which is included in this version of the course..</p>
