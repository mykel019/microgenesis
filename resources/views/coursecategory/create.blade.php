            ...
            <div class="row">
                <div class="col-md-10 col-sm-12 col-xs-12">
                    ...
                    <div class='x_panel'>
                        <div class='x_title '>
                            <div class="row">
                                <a href="{{url('coursecategory')}}" class="btn btn-app"><i class="fa fa-long-arrow-left"></i> Return</a>
                        ...
                        <div class='x_content'>
                            <form method="POST" action="{{url('coursecategory/store')}}" onsubmit="return false" id="form">
